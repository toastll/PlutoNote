...
public class MainActivity extends BaseActivity {
    ...
    private void getDatabaseData() {
        ...
        while (cursorRead.moveToNext()) {
            ...
            String noteTitle = cursorRead.getString(cursorRead.getColumnIndex(Constant.COLUMN_NAME_NOTE_TITLE));
            String noteContent = cursorRead.getString(cursorRead.getColumnIndex(Constant.COLUMN_NAME_NOTE_CONTENT));
